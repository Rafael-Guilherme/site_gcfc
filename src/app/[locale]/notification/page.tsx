      ...
      <div >
        <main className="flex flex-col">
          <div className='bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300 py-12 sm:py-16 lg:py-20 flex items-center justify-center px-4'>
            <div className='flex items-center justify-start max-w-[1500px] w-full'>
                <div className='flex flex-col sm:flex-row items-center justify-between w-full max-w-[836px] gap-4 sm:gap-0'>
                    <p className='text-black text-xs sm:text-sm text-center sm:text-left font-open-sans'>{t("notification.breadcrumb.home")} { '>' } {t("notification.breadcrumb.notified")}</p>
                    <h1 className='text-2xl sm:text-3xl lg:text-4xl font-medium text-center text-black uppercase'>{t("notification.title")}</h1>
                </div>
            </div>
          </div>
          <section className="py-12 sm:py-16 lg:py-20 bg-white px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto w-full">    
                <p className='text-black text-xs sm:text-sm text-center font-open-sans'>{t("notification.step1.number")}</p>
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12 sm:mb-16">
                <p className='text-black text-xs sm:text-sm text-center font-open-sans'>{t("notification.step2.number")}</p>
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-white px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto w-full">
              <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                <p className='text-black text-xs sm:text-sm text-center font-open-sans'>{t("notification.step3.number")}</p>
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12 sm:mb-16">
                <p className='text-black text-xs sm:text-sm text-center font-open-sans'>{t("notification.step4.number")}</p>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-medium text-[#6a0080]">
          ...
          <section className="max-w-[1480px] mx-auto flex flex-col lg:flex-row items-start justify-center bg-[#6a0080] text-white p-6 sm:p-8 lg:p-12 rounded-xl my-12 sm:my-16 lg:my-20 mx-4 sm:mx-6 lg:mx-8">
            ...
            <div className="lg:ml-8 mt-4 sm:mt-6 lg:mt-8 w-full lg:w-auto">
              <h2 className="text-xl sm:text-2xl font-bold mb-8 sm:mb-12">{t("notification.about.title")}</h2>
