...
export default function PrivacyPolicyPage() {
  ...
  return (    
    <main className="flex flex-col gap-12 sm:gap-16 lg:gap-20 pt-0 pb-8 sm:pb-12 bg-white min-h-screen">
      ...
      <section className="w-full max-w-7xl mx-auto px-12 sm:px-[84px] mb-6 sm:mb-8 ">
        <p className="font-semibold text-sm sm:text-base lg:text-lg text-[#4B006E] font-open-sans">{t("privacy.company.name")}</p>
        <p className="font-semibold text-sm sm:text-base lg:text-lg text-[#4B006E] font-open-sans">{t("privacy.company.cnpj")}</p>
        <p className="font-semibold text-sm sm:text-base lg:text-lg text-[#4B006E] font-open-sans">{t("privacy.company.description")}</p>
      </section>
      ...
      <section className="w-full max-w-7xl mx-auto space-y-8 sm:space-y-10 text-[#2d2d2d] text-xs sm:text-sm lg:text-base px-12 sm:px-[84px] font-open-sans">
        <div>
          <h3 className=" text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.hero.subtitle")}</h3>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.sections.title")}</h3>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.fundamentos.title")}</h3>
          <p className="mb-3 sm:mb-4">
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.processamento.title")}</h3>
          <p className="mb-3 sm:mb-4">
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.coleta.title")}</h3>
          <p className="mb-3 sm:mb-4">
            {t("privacy.coleta.p1")}
          </p>
        </div>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.outras_fontes.title")}</h3>
          <p className="mb-3 sm:mb-4">
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.consentimento.title")}</h3>
          <p className="mb-3 sm:mb-4">
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.direitos.title")}</h3>
          <p>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.protecao.title")}</h3>
          <p>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.transferencia.title")}</h3>
          <p>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.encarregado.title")}</h3>
          <p>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.atualizacoes.title")}</h3>
          <p>
        ...
        <div>
          <h3 className="font-bold text-[#4B006E] mb-8 text-sm sm:text-base font-heading">{t("privacy.contato.title")}</h3>
          <p>
