  ...
  return (
    <section className="my-20 max-w-[1480px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-8">
            ...
            <div className="sm:-mr-16 w-[300px] h-[200px] bg-gradient-to-bl from-gray-300 via-gray-100 to-gray-300 text-black flex flex-col justify-center items-start pl-2">
